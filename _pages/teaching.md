...
| Item      | Description                                                  |
| --------- | ------------------------------------------------------------ |
| 大作业要求 | 用Latex或overleaf([模板下载(zxwj)](https://pan.baidu.com/s/144VbIAGMZ3qCV-a3qxmstQ))写一篇短文(不少于2000字)，覆盖如下内容：<br/>摘要<br/>1. 课题价值和意义<br/>2. 当前研究进展（做了什么、怎么做的）<br/>3. 当前方法存在的主要问题<br/>4. 你的问题解决方案或思路<br/>5. 所提方案的优越性 <br/>总结 |
