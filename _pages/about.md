...
内部培养体系 —— 培养体系与主流IT企业和产业实践深度对接  
项目津贴支持 —— 根据参与度发放补贴，认可你的努力与成果  
积累真实经验 —— 深入AI应用场景，深入理解框架及开发技术  
实践能力认证 —— 提供项目实践和实习证明，助力升学与求职  
...
🚗 车联网与车计算 —— 面向智能驾驶与V2X协同推理的架构和方法  
🚁 无人机视觉计算 —— 空地协同、跨模态感知与动态神经网络技术  
🧠 垂直领域大模型 —— 工业、安全及智能交通领域的大模型及应用  
🔐 网络与信息安全 —— 加密流量检测、隐私保护与安全计算新方法  
