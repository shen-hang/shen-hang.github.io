...
2. **预训练AI大模型(ChatGPT、BERT)在网络安全、图谱推理领域的应用**：研究与开发并重。课题组有完整的研发团队，前期系统(包括：AI辅助文本标注工具、领域知识图谱系统)已实现产品化落地，新项目已启动。
3. **区块链技术及应用**：以应用研究为主。**课题组在南京可信区块链研究院(中国区块链百强第九名)建有研究生工作站，双方联合培养研究生。**
4. **边缘智能一体机**：从事面向AI芯片的模型蒸馏、剪裁、移植和系统开发。

**二、基本要求：**

1. 有目标且自律。**不以研究或学习为目的同学请绕行。**
2. 能够持之以恒(倾向“延迟满足”)。**偏向“即时满足”的同学请谨慎。**
3. 具备时间观念。**有严重拖延症的同学请绕行。**
