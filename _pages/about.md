...
1.  **预训练AI大模型在网络安全、图谱推理领域的应用**：研究与开发并重。课题组有完整的研发团队，前期系统(包括：AI辅助文本标注工具、领域知识图谱系统等)已实现产品化落地，新项目已启动。
2. **空天地一体化网络**：以探索性研究为主。前期成果发表于IEEE TVT、Elsevier JSA、PPNA、电子学报、通信学报、IEEE ICC、IEEE ISCC成果两次获得国家一级协会科技二等奖。
