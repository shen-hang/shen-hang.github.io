...
</div> <!-- ✅ 确保Recent Highlights结束 -->

<!-- 用一个单独的分隔区域清晰断开 -->
<div style="height:20px;"></div>
<hr style="border:0; height:1px; background:linear-gradient(to right, #fff, #ddd, #fff); margin:10px 0 24px 0;">
...
<div style="background-color:#f9f9f9; border-radius:10px; padding:18px 22px; line-height:1.6; font-size:15px; text-align:justify;">
  ...
  <a href="http://cise.njtech.edu.cn/" target="_blank">Department of Computer Science and Technology</a> at 
  <a href="http://www.njtech.edu.cn/" target="_blank">Nanjing Tech University</a>, China. 
  ...
  He is a CCF Senior Member, ACM Nanjing Chapter Executive Member, and IEEE Member.</p>
