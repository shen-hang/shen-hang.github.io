...
**🚀研究生招收：车联网、网络安全、大模型及嵌入式AI方向**<br/>**本人坚持一线指导，培养的研究生就职于顶级IT企业(包括：华为、中兴通讯、大疆、展锐、海康威视、大华、百度、华勤、微软中国、德州仪器、爱立信、诺基亚、三星研究院)和科技金融机构(包括：中行软开、微众银行、蚂蚁金融、南京证券)。有志读博的同学可推荐至国内外名校。**

**🌟本科生招收：嵌入式AI(智慧水务和边缘计算落地项目)、领域大模型及知识图谱(工业检测和智慧农业落地项目)开发者**<br/>**你是否渴望在实际项目中锻炼自己，快速成长为技术小咖？如果答案是肯定的，欢迎联系！**
