...
以下是2023年硕士生和校大创(本科生)招新计划：

**一、新生拟研究方向：**

1.  **空天地一体化网络**：以探索性研究为主。前期成果发表于IEEE TVT、Elsevier JSA、IEEE ICC、IEEE ISCC、PPNA，成果两次获得国家一级协会科技二等奖。
2. **预训练AI大模型(ChatGPT、BERT)在网络安全、图谱推理领域的应用**：研究与开发并重。前期系统已落地，新项目已启动。
3. **区块链技术及应用**：以应用研究为主。<font color="#000066">课题组在南京可信区块链研究院(中国区块链百强第九名)设有研究生工作站，双方联合培养研究生。</font>
4. **边缘智能一体机**：以设计和开发为主，涉及AI模型蒸馏、剪裁、移植和算法调度。
