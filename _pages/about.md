...
# Recent Highlights
- Mar. 2025: Congrats!!! 我们关于**车辆视觉计算**的论文“MT-DyNN: Multi-Teacher Distilled Dynamic Neural Network for Instance-Adaptive Detection in Autonomous Driving”被IEEE Transactions on Intelligent Transportation Systems(**中科院一区Top**)以长文形式录用. 
- Feb. 2024: Congrats!!! 我们关于多智能体协作的论文“Collaborative path penetration in 5G-IoT networks: A multi-agent deep reinforcement learning approach”被CCF推荐国际期刊Peer-to-Peer Networking and Applications录用. 
