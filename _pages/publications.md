...
1. **Hang Shen\***, Member, IEEE, Qi Liu, Yuanyi Wang, Tianjing Wang, Member, IEEE, and Guangwei Bai. MT-DyNN: Multi-Teacher Distilled Dynamic Neural Network for Instance-Adaptive Detection in Autonomous Driving, *IEEE Transactions on Intelligent Transportation Systems(TITS)*, 2025, Accepted for publication. (**中科院一区Top**) **[[Download](http://shen-hang.github.io/files/TITS2025.pdf)]**
