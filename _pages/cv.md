...
<div style="background-color:#f9f9f9; border-radius:10px; padding:12px 16px; line-height:1.6; font-size:15px; margin-bottom:16px;">
  ...
  - Annual Canadian Conference on Electrical and Computer Engineering (CCECE 2026) <br/>
  ...
  <p style="font-weight:bold; color:#2c3e50; margin-top:0; margin-bottom:8px;">
   ...
   <ol style="padding-left:20px; margin:0;">
    ...
    <li>
      ...
      <i>Elsevier Computer Networks (ComNet)</i>, 2026, Volume 283, no. 112336. 
      <b>(CCF Rank-B)</b> 
...
<li>
  ...
  <a href="http://shen-hang.github.io/files/IoT2026.pdf" style="color:#1E90FF; text-decoration:none;">[Download]</a>
    ...
    <li>
      ...
      <i>Peer-to-Peer Networking and Applications (PPNA)</i>, 2024, 17, pp. 1631–1644. 
    ...
    <li>
      ...
      <i>ETRI Journal</i>, 2023, 45(5), pp. 874–886. 
    ...
    <li>
      ...
      <i>Wireless Personal Communications (WPC)</i>, 2015, 82(1), pp. 401–422.
    </li>
